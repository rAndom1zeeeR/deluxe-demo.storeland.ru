...
function goodspage() {
  ...
  /*$('.productView__opinion .owl-carousel').owlCarousel({
    ...
    lazyLoad: true,
    nav: true,
    navContainer: '.productView__opinion .owl-nav',
    navText: [ , ],
    dots: true,
...
function pdtSlider() {
  ...
  $('#pdt__sales .owl-carousel').owlCarousel({
    ...
    navText: [ , ],
    dots: true,
    dotsContainer: '#pdt__sales .owl-dots',
    autoHeight: false,
    autoHeightClass: 'owl-height',
    autoplay: false,
    autoplayHoverPause: true,
  ...
  $('#pdt .block__nav .owl-prev').on('click', function(event) {
    $('#pdt .owl-carousel').trigger('prev.owl.carousel');
  });
  $('#pdt .block__nav .owl-next').on('click', function(event) {
